...
<svg width="400" height="280" xmlns="http://www.w3.org/2000/svg">
  <!-- Person class -->
  <rect x="140" y="20" width="120" height="100" fill="#e1f5fe" stroke="#01579b" stroke-width="2" rx="5"/>
  <text x="200" y="35" text-anchor="middle" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#01579b">Person</text>
  <line x1="145" y1="45" x2="255" y2="45" stroke="#01579b" stroke-width="1"/>
  <text x="150" y="60" font-family="Arial, sans-serif" font-size="12" fill="#000">String name</text>
  <text x="150" y="75" font-family="Arial, sans-serif" font-size="12" fill="#000">int age</text>
  <line x1="145" y1="85" x2="255" y2="85" stroke="#01579b" stroke-width="1"/>
  <text x="150" y="100" font-family="Arial, sans-serif" font-size="12" fill="#000">speak()</text>
  <!-- Employee class -->
  <rect x="140" y="180" width="120" height="80" fill="#e8f5e8" stroke="#1b5e20" stroke-width="2" rx="5"/>
  <text x="200" y="195" text-anchor="middle" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="#1b5e20">Employee</text>
  <line x1="145" y1="205" x2="255" y2="205" stroke="#1b5e20" stroke-width="1"/>
  <text x="150" y="220" font-family="Arial, sans-serif" font-size="12" fill="#000">int employeeId</text>
  <line x1="145" y1="230" x2="255" y2="230" stroke="#1b5e20" stroke-width="1"/>
  <text x="150" y="245" font-family="Arial, sans-serif" font-size="12" fill="#000">work()</text>
  <!-- Inheritance arrow -->
  <line x1="200" y1="180" x2="200" y2="120" stroke="#ff0000" stroke-width="3" marker-end="url(#arrow)"/>
  <defs>
